...
void ACstSpatialAudioCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ACstSpatialAudioCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACstSpatialAudioCharacter::Move);
...
void ACstSpatialAudioCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACstSpatialAudioCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
